import { AlertCircle, ArrowRight, Clock3, Database, Radio, Server, UploadCloud } from 'lucide-react';
      ...
      <div className="mx-auto max-w-6xl space-y-8">
        <section className="flex flex-col gap-3 border-b border-black/10 pb-7 dark:border-white/10 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <h1 className="text-3xl font-semibold tracking-tight">V1 telemetry overview</h1>
            ...
            <div className="divide-y divide-black/5 dark:divide-white/5">
              {devices.map((device) => (
                <button
                  ...
                  className="grid w-full gap-4 px-5 py-4 text-left transition-colors hover:bg-black/[0.025] dark:hover:bg-white/[0.03] md:grid-cols-[minmax(0,1.8fr)_0.8fr_0.8fr_1fr_auto] md:items-center"
                >
